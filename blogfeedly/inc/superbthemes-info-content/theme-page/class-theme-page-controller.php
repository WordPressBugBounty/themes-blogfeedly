...
class ThemePageController
{
    ...
    public static function ThemePageSubMenu()
    {
        ...
        add_submenu_page('themes.php', __('Theme Settings', 'blogfeedly'), __('Theme Settings', 'blogfeedly') . $awaiting, 'manage_options', self::GetPageSlug(), array(__CLASS__, 'ThemePageContent'), 1);
    }
